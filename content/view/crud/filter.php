<?php
	...
	$qry = "SELECT * FROM {$tblname} WHERE fieldtxt LIKE :searchforx OR {$prim_id} LIKE :searchforx AND deletedx=0 ORDER BY {$prim_id} DESC LIMIT :from_record_num, :records_per_page";
